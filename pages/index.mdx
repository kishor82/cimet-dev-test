...
We are expecting:
- make sure you code can run stand alone
- no error or warning messages in client or backend consoles
- best practice in react and node(you should avoid not recommended or risky code)
...
![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) Must attatch screenshots of a desktop and a mobile.

![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) Must not use proxy or chrome plugins, you need to run a server(or nextjs)

![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) Do not leave any unused code

![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) if you are using .evn file, you have to commit it.
...
### Please add http header Api-key with 4NKQ3-815C2-8T5Q2-16318-55301 when making any requests.
  ...
  1. You need to generate a token using the token API. (it will last for 3hrs, check the response and try to reuse the key) 
